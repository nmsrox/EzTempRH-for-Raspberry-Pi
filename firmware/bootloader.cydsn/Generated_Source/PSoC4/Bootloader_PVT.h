...
#define Bootloader_FIRST_APP_BYTE(appId)      ((uint32)CYDEV_FLS_ROW_SIZE * \
        ((uint32) Bootloader_GetMetadata(Bootloader_GET_METADATA_BTLDR_LAST_ROW, appId) + \
         (uint32) 1u))
...
*******************************************************************************/
#define Bootloader_GET_METADATA_BTLDB_ADDR             (1u)
#define Bootloader_GET_METADATA_BTLDR_LAST_ROW         (2u)
#define Bootloader_GET_METADATA_BTLDB_LENGTH           (3u)
#define Bootloader_GET_METADATA_BTLDR_APP_VERSION      (4u)
#define Bootloader_GET_METADATA_BTLDB_APP_VERSION      (5u)
#define Bootloader_GET_METADATA_BTLDB_APP_ID           (6u)
#define Bootloader_GET_METADATA_BTLDB_APP_CUST_ID      (7u)
...
*******************************************************************************/
#define Bootloader_MD_BTLDB_CHECKSUM_PTR  (appId)    \
            ((reg8 *)(Bootloader_MD_BTLDB_CHECKSUM_OFFSET(appId)))
#define Bootloader_MD_BTLDB_CHECKSUM_VALUE(appId)    \
            (CY_GET_XTND_REG8(Bootloader_MD_BTLDB_CHECKSUM_OFFSET(appId)))

#define Bootloader_MD_BTLDB_ACTIVE_PTR(appId)        \
            ((reg8 *)(Bootloader_MD_BTLDB_ACTIVE_OFFSET(appId)))
#define Bootloader_MD_BTLDB_ACTIVE_VALUE(appId)      \
            (CY_GET_XTND_REG8(Bootloader_MD_BTLDB_ACTIVE_OFFSET(appId)))

#define Bootloader_MD_BTLDB_VERIFIED_PTR(appId)      \
            ((reg8 *)(Bootloader_MD_BTLDB_VERIFIED_OFFSET(appId)))
#define Bootloader_MD_BTLDB_VERIFIED_VALUE(appId)    \
            (CY_GET_XTND_REG8(Bootloader_MD_BTLDB_VERIFIED_OFFSET(appId)))


/*******************************************************************************
* Macro for multiple bytes long metadata fields pointers 
*******************************************************************************/
#define Bootloader_MD_BTLDB_ADDR_PTR  (appId)        \
            ((reg8 *)(Bootloader_MD_BTLDB_ADDR_OFFSET(appId)))

#define Bootloader_MD_BTLDR_LAST_ROW_PTR  (appId)    \
            ((reg8 *)(Bootloader_MD_BTLDR_LAST_ROW_OFFSET(appId)))

#define Bootloader_MD_BTLDB_LENGTH_PTR(appId)        \
            ((reg8 *)(Bootloader_MD_BTLDB_LENGTH_OFFSET(appId)))

#define Bootloader_MD_BTLDR_APP_VERSION_PTR(appId)    \
            ((reg8 *)(Bootloader_MD_BTLDR_APP_VERSION_OFFSET(appId)))

#define Bootloader_MD_BTLDB_APP_ID_PTR(appId)         \
            ((reg8 *)(Bootloader_MD_BTLDB_APP_ID_OFFSET(appId)))

#define Bootloader_MD_BTLDB_APP_VERSION_PTR(appId)    \
            ((reg8 *)(Bootloader_MD_BTLDB_APP_VERSION_OFFSET(appId)))

#define Bootloader_MD_BTLDB_APP_CUST_ID_PTR(appId)    \
            ((reg8 *)(Bootloader_MD_BTLDB_APP_CUST_ID_OFFSET(appId)))
